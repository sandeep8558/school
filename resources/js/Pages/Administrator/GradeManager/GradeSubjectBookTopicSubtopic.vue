...
export default {
    ...
    data: function () {
        return {
            ...
            crud : {
                title: 'Grade Subject Book Subtopic Manager',
                model: 'GradeSubjectBookSubtopic',
                files: '',
                data: null,
                rows: 10,
                orderBy: 'id',
                order: 'desc',
                with: 'grade_subject_book_topic,grade_subject_book,grade_subject_book,grade,subject',
                table: [
                    {
                        field: 'id',
                        text: 'No.',
                    ...
                    {
                        field:'grade_subject_book_topic_id',
                        text:'Book Topic',
                        type:'select',
                        value:null,
                        values:[],
                    ...
                    },
                    {
                        ...
                        validation: '',
                        display: true,
                        display_value: 'grade_subject_book_topic,topic',
                        isForm: false,
                        isSearch: true,
                        colWidth: 'w-auto',
                        fieldWidth: 'w-full' 
    ...
    methods: {
        ...
        async crudChange(e){
            ...
            if(e.key == 'grade_subject_book_id'){
                const response = await fetch('/grade_manager/fetch/grade_subject_book_topic/' + e.val);
                this.crud.table[4].values = await response.json();
            }
