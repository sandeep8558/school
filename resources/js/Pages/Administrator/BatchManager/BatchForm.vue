...
<template>
    <div class="bg-white p-6 md:w-96 rounded-lg shadow-lg border">
        ...
        <div>
            <h2 class="text-xl font-bold inline-block">Create {{ title }}</h2>
        ...
        <div class="">
            <button :disabled="isValid" :class="isValid ? 'btn-disbled' : 'btn-purple'" class="btn" @click="$emit('save', {classroom_id: classroom_id, student_shift_id: student_shift_id})">Save Batch</button>
        </div>
