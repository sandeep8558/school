...
<table class="w-100">
    <tbody>
        <tr>
            ...
            <td class="p-10">
                <h3 class="p-0 m-0 uppercase">{{$school_name}}</h3>
                <p class="p-0 m-0 text-md">{{$tag_line}}</p>
            </td>
        </tr>
        <tr>
            <td colspan="2">
        ...
        <tr>
            <td class="text-sm py-5 text-center" colspan="2">
                <p>{{$address}} {{$city}} {{$pincode}} {{$state}} {{$country}} <br> {{$email_address}} / {{$phone_number}}</p>
            </td>
        </tr>
        <tr>
            <td colspan="2">
